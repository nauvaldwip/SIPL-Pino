...
WebUI.click(findTestObject('Page_LEMDIKLAT POLRI/span_Satker'))

WebUI.click(findTestObject('Page_LEMDIKLAT POLRI/button_Tambah (1)'))

WebUI.setText(findTestObject('Page_LEMDIKLAT POLRI/input_()_institution_name'), 'Shopee COD')

WebUI.setText(findTestObject('Page_LEMDIKLAT POLRI/textarea_()_institution_address'), 'Jakarta')

WebUI.setText(findTestObject('Page_LEMDIKLAT POLRI/input_()_institution_phone'), '081377568839')

WebUI.click(findTestObject('Page_LEMDIKLAT POLRI/button_Simpan (2)'))
